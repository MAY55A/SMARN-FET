...
class _AddSpaceConstraintViewState extends State<AddSpaceConstraintView> {
            ...
            child: Column(
              ...
              children: [
                ...
                if (_selectedType == SpaceConstraintType.preferredRoom) ...[
                  DropdownButton<String?>( // Room dropdown
                  ...
                  const SizedBox(height: 16),
                  DropdownButton<String?>( // Teacher dropdown
                  ...
                  const SizedBox(height: 16),
                  DropdownButton<String?>( // Class dropdown
                  ...
                  const SizedBox(height: 16),
                  DropdownButton<String?>( // Subject dropdown
  ...
  void _saveConstraint() async {
    if (_selectedType == null || 
        (_selectedType == SpaceConstraintType.roomType && _selectedRoomType == null) || 
        (_selectedType == SpaceConstraintType.preferredRoom && 
        (_selectedRoomId == null || _selectedTeacherId == null || _selectedClassId == null || _selectedSubjectId == null))) {
